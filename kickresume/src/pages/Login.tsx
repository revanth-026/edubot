...
<div className="bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20 transform transition-all duration-300 hover:scale-[1.02] hover:shadow-3xl">
{/* Header */}
<div className="text-center mb-8">
<div className="w-16 h-16 bg-gradient-to-br from-[#2F3C7E] to-[#00C9A7] rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg transform transition-transform duration-300 hover:rotate-6">
...
{/* Email Field */}
<div className="group">
<label className="block mb-2 text-[#212529] font-semibold text-sm">Email Address</label>
<div className="relative">
<div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
<Mail className="text-[#6C757D] group-focus-within:text-[#00C9A7] transition-colors duration-200" size={20} />
</div>
<input
type="email"
value={email}
...
className="w-full border-2 border-[#E9ECEF] rounded-xl pl-12 pr-4 py-4 text-[#212529] placeholder-[#6C757D] outline-none focus:border-[#00C9A7] focus:ring-4 focus:ring-[#00C9A7]/10 transition-all duration-300 bg-white/90 backdrop-blur-sm hover:border-[#00C9A7]/50 relative z-0"
/>
</div>
</div>
...
{/* Password Field */}
<div className="group">
<label className="block mb-2 text-[#212529] font-semibold text-sm">Password</label>
<div className="relative">
<div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none z-10">
<Lock className="text-[#6C757D] group-focus-within:text-[#00C9A7] transition-colors duration-200" size={20} />
</div>
<input
...
required
placeholder="••••••••"
className="w-full border-2 border-[#E9ECEF] rounded-xl pl-12 pr-12 py-4 text-[#212529] placeholder-[#6C757D] outline-none focus:border-[#00C9A7] focus:ring-4 focus:ring-[#00C9A7]/10 transition-all duration-300 bg-white/90 backdrop-blur-sm hover:border-[#00C9A7]/50 relative z-0"
/>
<button
type="button"
onClick={() => setShowPassword(!showPassword)}
className="absolute inset-y-0 right-0 pr-4 flex items-center text-[#6C757D] hover:text-[#00C9A7] transition-colors duration-200 z-10"
>
...
className="w-full bg-gradient-to-r from-[#2F3C7E] to-[#00C9A7] text-white py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center group disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none"
>
{isLoading ? (
