      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <a href="#templates" className="text-[#6C757D] hover:text-[#2F3C7E] transition-colors duration-200">
              Templates
            </a>
            <a href="#features" className="text-[#6C757D] hover:text-[#2F3C7E] transition-colors duration-200">
              Features
            </a>
            <a href="#testimonials" className="text-[#6C757D] hover:text-[#2F3C7E] transition-colors duration-200">
              Reviews
            </a>
            <Link 
              to="/login"
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-[#E9ECEF]">
              <a href="#templates" className="block px-3 py-2 text-[#6C757D] hover:text-[#2F3C7E] transition-colors duration-200">
                Templates
              </a>
              <a href="#features" className="block px-3 py-2 text-[#6C757D] hover:text-[#2F3C7E] transition-colors duration-200">
                Features
              </a>
              <a href="#testimonials" className="block px-3 py-2 text-[#6C757D] hover:text-[#2F3C7E] transition-colors duration-200">
                Reviews
              </a>
              <Link 
                to="/login" 
